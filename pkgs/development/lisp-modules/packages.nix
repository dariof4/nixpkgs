...
let
  ...
  quri = build-asdf-system {
    ...
    lispLibs = [super.babel super.alexandria super.split-sequence super.cl-utilities];
  };

  cl-colors2 = build-asdf-system {
    inherit (super.cl-colors2) pname;
    version = "0.5.3";
    ...
    lispLibs = [super.alexandria super.cl-ppcre];
  };

  cl-webkit2 = build-asdf-system {
    inherit (super.cl-webkit2) pname;
    version = "3.5.8";
  ...
  prompter = build-asdf-system {
    ...
    lispLibs = [super.alexandria super.calispel self.cl-containers super.closer-mop super.lparallel super.moptilities self.nclasses super.serapeum super.str super.trivial-package-local-nicknames];
  ...
  nclasses = build-asdf-system {
    ...
    lispLibs = [super.moptilities self.nasdf];
  };

  nfiles = build-asdf-system {
    inherit (super.nfiles) pname;
    version = "1.1.2";
    src = pkgs.fetchFromGitHub {
      owner = "atlas-engineer";
      repo = "nfiles";
